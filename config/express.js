...
module.exports = function () {
    ...
    app.use(bodyParser.raw({ type: 'image/jpeg', limit: '50mb' })); //for images
    app.use(bodyParser.raw({ type: 'image/png', limit: '50mb' }));  //for images
    app.use(bodyParser.raw({ type: 'image/gif', limit: '50mb' }));  //for images
